...
public class C06_Polymorphism {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("f가 Fruit이 될 수 있는 인스턴스 인가요? "+(f instanceof Fruit));
      System.out.println("f가 Fruit이 될 수 있는 인스턴스 인가요? "+(f instanceof Pineapple));
      System.out.println("f가 Fruit이 될 수 있는 인스턴스 인가요? "+(f instanceof DragonFruit));
   
      System.out.println("f2가 Fruit이 될 수 있는 인스턴스 인가요? "+(f2 instanceof Fruit));
      System.out.println("f2가 Fruit이 될 수 있는 인스턴스 인가요? "+(f2 instanceof Pineapple));
      System.out.println("f2가 Fruit이 될 수 있는 인스턴스 인가요? "+(f2 instanceof DragonFruit));
   }
...
// class 이름에 Apple이 안되는 이유. 같은 패키지 내부에는 같은 이름의 클래스가 존재할 수 없다.
